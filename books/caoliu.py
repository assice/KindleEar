...
class BaseFeedBook:
    ...
    oldest_article        = 1    #下载多长时间之内的文章，小于等于365则单位为天，大于365则单位为秒，0为不限制
    ...
    language = 'zh-cn' #最终书籍的语言定义，比如zh-cn,en等
    ...
    feed_encoding = [
            ...
            (u'達蓋爾的旗幟', 'https://rsshub.app/t66y/7'),
            (u'文學交流區', 'https://rsshub.app/t66y/7'),
            ] # RSS编码，一般为XML格式，直接打开源码看头部就有编码了
